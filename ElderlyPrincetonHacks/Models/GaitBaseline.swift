...
/// Baseline captured during calibration walk (deviceMotion: gravity + userAcceleration).
struct GaitBaseline: Codable, Equatable {
    ...
    var sampleCount: Int
    var recordedAt: Date
    /// Composite score at calibration time (same formula as `GaitRecord.overallScore`).
...
/// Live comparison vs baseline + simple “bad habit” flags for demo UI.
